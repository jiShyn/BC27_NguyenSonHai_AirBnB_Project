                        ...
                        <Row gutter={[32, 16]}>
                           ...
                           <Col span={14}>
                              ...
                              <div className="text-secondary mb-3">
                                 {room.mayGiat && (
                                    <span className="me-2">Máy giặt</span>
                                 )}
                                 {room.banLa && (
                                    <span className="me-2">Bàn là</span>
                                 )}
                                 {room.tivi && (
                                    <span className="me-2">Tivi</span>
                                 )}
                                 {room.dieuHoa && (
                                    <span className="me-2">Điều hòa</span>
                                 )}
                                 {room.wifi && (
                                    <span className="me-2">Wifi</span>
                                 )}
                                 {room.bep && (
                                    <span className="me-2"> Bếp</span>
                                 )}
                                 {room.doXe && (
                                    <span className="me-2">Đỗ xe</span>
                                 )}
                                 {room.hoBoi && (
                                    <span className="me-2">Hồ bơi</span>
                                 )}
                                 {room.banUi && (
                                    <span className="me-2">Bàn ủi</span>
                                 )}
                              </div>
